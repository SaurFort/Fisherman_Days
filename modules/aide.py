...
class Aide:
    def afficher_aide_joueur(self):
        ...
        if choix == "1" :
            ...
            print("🔍 En pêchant, vous collectez un poisson, plus ou moins rare \nque vous pourrez revendre en rentrant au port.")
        elif choix == "3" :
            ...
            print("🔍 Le fioul représenté en Litres (L), vous annonce le nombre de fois que vous pouvez pêcher avant de rentrer au port.\n Une fois le réservoir vide, vous serez directement redirigé vers le port.")
        elif choix == "13" :  
            return
